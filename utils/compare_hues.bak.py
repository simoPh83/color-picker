...
# first argument: a list with the RGB values of the first colour
# second argument: a list with the RGB values of the second colour
# third argument: a number addressing the right list in hues_lists.py, based on needed quantization accuracy
print(compare_colours(colour1, colour2, 6))
